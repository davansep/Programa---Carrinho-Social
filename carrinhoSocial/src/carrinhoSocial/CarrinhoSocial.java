...
public class CarrinhoSocial {
	...
	public static void opcaoAdicionar(int opcaoMenuCategoria, ListagemProdutos listaProdutos, Scanner in, int indice,
			int quantidade) {
	...
	public static void opcaoSubtrair(int opcaoMenuCategoria, ListagemProdutos listaProdutos, Scanner in, int indice,
			int quantidade) {
		switch (opcaoMenuCategoria) {
		case 1: {
			System.out.println("\nQual produto deseja?\n");
